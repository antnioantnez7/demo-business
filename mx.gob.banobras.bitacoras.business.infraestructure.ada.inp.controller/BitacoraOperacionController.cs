...
namespace banobras_bitacoras_business.mx.gob.banobras.bitacoras.business.infraestructure.ada.inp.controller
{
    ...
    public class BitacoraOperacionController : ControllerBase
    {
        ...
        /// 
        ///     POST bitacora/operaciones/registrar
        ///     {
        ///         "identificador":0
        ///         "aplicativoId": "MAC",
        ///         "capa": "business",
        ...
        [Route("registrar")]
        [ProducesResponseType(typeof(BitacoraResponse<BitacoraDtoResponse>), 200)]
        [ProducesResponseType(typeof(BitacoraResponse<BitacoraDtoResponse>), 400)]
        [ProducesResponseType(typeof(BitacoraResponse<BitacoraDtoResponse>), 403)]
        [ProducesResponseType(typeof(BitacoraResponse<BitacoraDtoResponse>), 500)]
        ...
        /// <br>Ejemplo request: </br>
        /// 
        ///     POST bitacora/operaciones/consultar
        ///     {
        ///         "aplicativoId": "MAC",
        ...
        [Consumes("application/json")]
        [Route("consultar")]
        [ProducesResponseType(typeof(BitacoraResponse<List<BitacoraOperacionDto>>), 200)]
        [ProducesResponseType(typeof(BitacoraResponse<List<BitacoraOperacionDto>>), 400)]
        [ProducesResponseType(typeof(BitacoraResponse<List<BitacoraOperacionDto>>), 403)]
        [ProducesResponseType(typeof(BitacoraResponse<List<BitacoraOperacionDto>>), 500)]
